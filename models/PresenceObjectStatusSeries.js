const PresenceObjectStatusSeriesTable = db.defineTable('PresenceObjectStatusSeries', {
  columns: {
  ...
  keys: [
    ...
    db.KeyTypes.index('PresenceObject', 'Status', 'DateTimeEnd'),
  ],
});

const PresenceObjectStatusSeries = {
  ...
  GetByDeviceId(deviceid, stat, days = 1) {
    return db.pquery(`
      ...
      FROM PresenceObjectStatusSeries dss
...
module.exports = PresenceObjectStatusSeries;