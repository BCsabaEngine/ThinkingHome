    ...
    db.query("SELECT * FROM Device d", function (err, devicerows) {
      ...
      devicerows.forEach((devicerow) => {
        try {
          ...
          const deviceState = new DeviceState(deviceid, devicerow.Name, devicerow.DisplayName);
