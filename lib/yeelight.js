...
class Yeelight extends EventEmitter {
    ...
    connect(cb) {
        ...
        this.connectiontimer = setInterval(this.connectIfNeeded.bind(this), 60 * 1000)
    }
    ...
    updateState() { this.sendCommand('get_prop', ['power', 'color_mode', 'ct', 'rgb', 'hue', 'sat', 'bright']) }
