...
class RunningContext {
  ...
  StopRuleCodeExecutors() {
    for (const rce of Object.keys(this.rulecodeexecutors)) {
      this.rulecodeexecutors[rce].Stop()
    }
    if (process.hasUncaughtExceptionCaptureCallback()) process.setUncaughtExceptionCaptureCallback(null)
    this.rulecodeexecutors = {}
  ...
  GetRuleCodeExecutorConsoleLines(id) {
    if (Object.prototype.hasOwnProperty.call(this.rulecodeexecutors, id)) {
      return this.rulecodeexecutors[id].GetConsoleLines()
    }
    return []
  }
  ...
  OnRuleCodeExecutorMinute() {
    if (this.rulecodeexecutors) {
      for (const rce of Object.keys(this.rulecodeexecutors)) {
        this.rulecodeexecutors[rce].DoEveryMinute()
      }
    }
  }
  ...
  OnRuleCodeExecutorHour() {
    if (this.rulecodeexecutors) {
      for (const rce of Object.keys(this.rulecodeexecutors)) {
        this.rulecodeexecutors[rce].DoEveryHour()
      }
    }
  }
